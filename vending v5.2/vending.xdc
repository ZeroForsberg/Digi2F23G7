...
set_property PACKAGE_PIN V15 [get_ports {io_price[5]}]
...
set_property PACKAGE_PIN U3  [get_ports {io_led1}]
set_property PACKAGE_PIN P3  [get_ports {io_led2}]
set_property PACKAGE_PIN N3  [get_ports {io_led3}]
set_property PACKAGE_PIN P1  [get_ports {io_led4}]
